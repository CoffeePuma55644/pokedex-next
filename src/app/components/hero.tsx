...
import { Box, Search, Heart, Info, Zap, Book } from "lucide-react";
      ...
      <div className="hero-content text-center">
        <div className="max-w-4xl">
          ...
          <p className="text-lg mb-8 text-base-content/60 max-w-2xl mx-auto">
            Découvrez plus de 1000 Pokémon, leurs statistiques, évolutions,
            capacités et bien plus encore. Attrapez-les tous avec notre Pokédex
            interactif !
          </p>
